...
* Tests
 ...
 The graphs are generated with gnuplot directly from the tables of the
...
*** Open ports
    ...
    This tests uses nmap (also netstat to double check) to see the network ports
...
**** open protocols
    ...
    | Open protocols IPv6 |                                                                                | 0 (hopopt), 4 (ipv4), 6 (tcp), 17 (udp), 41 (ipv6), 43 (ipv6), 44 (ipv6), 47 (gre), 50 (esp), 51 (ah), 58 (ipv6), 59 (ipv6), 60 (ipv6), 108 (ipcomp), 132 (sctp), 136 (udplite), 255 (unknown) |                                                                                | 0 (hopopt), 6 (tcp), 17 (udp), 43 (ipv6), 44 (ipv6), 58 (ipv6), 59 (ipv6), 60 (ipv6), 136 (udplite), 255 (unknown) |                | 0 (hopopt), 6 (tcp), 17 (udp), 43 (ipv6), 44 (ipv6), 58 (ipv6), 59 (ipv6), 60 (ipv6), 103 (pim), 136 (udplite), 255 (unknown) |
    |---------------------+--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------+----------------+-------------------------------------------------------------------------------------------------------------------------------|
